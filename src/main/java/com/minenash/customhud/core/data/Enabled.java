...
public class Enabled {
    ...
    public static final int DIFFICULTY = 0b000000000010000;
    public static final int               WORLD = 0b000000000100000;
    public static final int               SOUND = 0b000000001000000;
    public static final int TARGET_BLOCK_EN = 0b000000010000000;
    public static final int TARGET_FLUID_EN = 0b000000100000000;
